...
public class DataLoader {
	...
	public DataLoader() {
		...
		FileReader data = readShoppingTripTestDataFile();
		trip = this.loadShoppingTrips(data);
	...
	/**
	 * Constructor used by web-server handler for creating the new ShoppingTrips 
	 * @param JSON-string, contents of ShoppingTrip
	 */
	public DataLoader(String data) {
		StringReader reader = new StringReader(data);
		trip = this.loadShoppingTrip(data);
	}
	
	/**
	 * Reads test-data file for ShoppingTrip
	 * @return data FileReader with JSON-data
	 */
	private FileReader readShoppingTripTestDataFile() {
		// loads trips
		...
		try {
			data = new FileReader(relativePath + pathToTrip);
	...
	public ShoppingTrip loadShoppingTrip(String data) {
	 ...
	 * @return shoppingTrip
	 */
	public ShoppingTrip loadShoppingTrips(Reader data) {
		JSONParser parser = new JSONParser();
